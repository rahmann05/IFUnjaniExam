                        ...
                        if (response.getBoolean("success")) {
                            ...
                            KelasAdapter adapter = new KelasAdapter(data, kelasObj -> {
                                try {
                                    ...
                                    // TODO: Lanjut ke halaman Ujian dengan meneruskan classId via Intent Extra
                                    android.content.Intent intent = new android.content.Intent(this, CreateExamActivity.class);
